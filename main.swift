...
print(numbers)
//3
let dict = ["C++": 1991, "Java": 1996, "Swift": 2014]
let swiftYear = dict["Swift"]
print(swiftYear!)
//4
...
//3
var students2: Dictionary<String, Int> = ["Alma": 0, "Aruzhan": 0, "Aidana": 0]
var grades: [Int] = [95, 100, 70]
students2["Alma"] = grades[0]
students2["Aruzhan"] = grades[1]
students2["Aidana"] = grades[2]
print(students2)
